...
public class TestSerialMsg extends net.tinyos.message.Message {
    ...
    public String toString() {
      ...
      try {
        s += "  [duck=0x"+Long.toHexString(get_duck())+"]\n";
      } catch (ArrayIndexOutOfBoundsException aioobe) { /* Skip field */ }
      try {
     ...
     * Return whether the field 'commander' is signed (false).
     */
    public static boolean isSigned_duck() {
        return false;
    }
     ...
     * Return whether the field 'commander' is an array (false).
     */
    public static boolean isArray_duck() {
        return false;
    }
     ...
     * Return the offset (in bits) of the field 'commander'
     */
    public static int offsetBits_duck() {
        return 144;
    }
     ...
     */
    public int get_duck() {
        return (int)getUIntBEElement(offsetBits_duck(), 16);
    }

    /**
     * Set the value of the field 'commander'
     */
    public void set_duck(int value) {
        setUIntBEElement(offsetBits_duck(), 16, value);
    }

    /**
     * Return the size, in bytes, of the field 'commander'
     */
    public static int size_duck() {
        return (16 / 8);
    }
     ...
     * Return the size, in bits, of the field 'commander'
     */
    public static int sizeBits_duck() {
        return 16;
    }
