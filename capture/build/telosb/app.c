...
extern int memcmp(const void *arg_0x2ba53c0dbde8, const void *arg_0x2ba53c0da100, size_t arg_0x2ba53c0da3a8);
extern void *memcpy(void *arg_0x2ba53c0dabf0, const void *arg_0x2ba53c0e0020, size_t arg_0x2ba53c0e02c8);

extern void *memset(void *arg_0x2ba53c0df980, int arg_0x2ba53c0dfbe8, size_t arg_0x2ba53c0de020);
#line 61
extern void *memset(void *arg_0x2ba53c0f8b10, int arg_0x2ba53c0f8d78, size_t arg_0x2ba53c0f7060);
...
struct _reent {
  ...
  void (*__cleanup)(struct _reent *arg_0x2ba53c139290);
  ...
  void (**_sig_func)(int arg_0x2ba53c13e300);
...
typedef nx_struct CaptureMessage {
  ...
  nx_uint16_t rssi;
} __attribute__((packed)) CaptureMessage;
#line 38
#line 27
typedef nx_struct SuccessMessage {
  ...
  nx_uint16_t nbr1capture[100];
} __attribute__((packed)) SuccessMessage;
...
typedef TMilli Capture__Timer0__precision_tag;
typedef TMilli Capture__Timer1__precision_tag;
typedef TMilli Capture__Timer2__precision_tag;
...
static void Capture__Timer0__fired(void );
# 55 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Config.nc"
static void Capture__CC2420Config__syncDone(error_t error);
# 60 "/opt/tinyos-2.1.2/tos/interfaces/Boot.nc"
static void Capture__Boot__booted(void );
# 113 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static void Capture__SerialControl__startDone(error_t error);
#line 138
static void Capture__SerialControl__stopDone(error_t error);
#line 113
static void Capture__RadioControl__startDone(error_t error);
#line 138
static void Capture__RadioControl__stopDone(error_t error);
...
Capture__RadioReceive__receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void Capture__Timer1__fired(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void Capture__RadioAMSend__sendDone(
#line 103
message_t * msg, 
...
Capture__SerialReceive__receive(
#line 71
message_t * msg, 
void * payload, 
...
uint8_t len);
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void Capture__Timer2__fired(void );
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void Capture__SerialAMSend__sendDone(
#line 103
message_t * msg, 
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static void /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(
#line 96
message_t * msg, 
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void Capture__Timer0__startPeriodic(uint32_t dt);
#line 78
static void Capture__Timer0__stop(void );
# 61 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Config.nc"
static void Capture__CC2420Config__setChannel(uint8_t channel);
#line 54
static error_t Capture__CC2420Config__sync(void );
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t Capture__SerialControl__start(void );
# 56 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Packet.nc"
static void Capture__CC2420Packet__setPower(message_t *p_msg, uint8_t power);
...
Capture__RadioPacket__getPayload(
#line 121
message_t * msg, 
...
uint8_t len);
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
static error_t Capture__RadioControl__start(void );
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void Capture__Timer1__startPeriodic(uint32_t dt);
#line 78
static void Capture__Timer1__stop(void );
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t Capture__RadioAMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
static void Capture__Leds__set(uint8_t val);
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
static void Capture__Timer2__startPeriodic(uint32_t dt);
#line 78
static void Capture__Timer2__stop(void );
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static error_t Capture__SerialAMSend__send(am_addr_t addr, 
#line 71
message_t * msg, 
...
uint8_t len);
# 29 "Capture.nc"
uint16_t Capture__NUM_REPEAT = 100;
uint16_t Capture__POWER = 10;
uint16_t Capture__NUM_MESSAGE = 100;

enum Capture____nesc_unnamed4312 {
  Capture__MODE_NODE = 0, 
  Capture__MODE_PREPROCESS = 1, 
  Capture__MODE_WATING1 = 2, 
  Capture__MODE_SENDREQUEST = 3, 
  Capture__MODE_WATING2 = 4, 
  Capture__MODE_PRINT = 5
};



enum Capture____nesc_unnamed4313 {
  Capture__MODE2_NODE = 0, 
  Capture__MODE2_PREPROCESS = 1, 
  Capture__MODE2_SENDRETURN = 2
};



uint16_t Capture__commander = -1;

uint16_t Capture__mode = Capture__MODE_NODE;
uint16_t Capture__mode2 = Capture__MODE2_NODE;
uint16_t Capture__nodes[150] = { 0 };
uint16_t Capture__capture1[100] = { 0 };
uint16_t Capture__capture2[100] = { 0 };
uint16_t Capture__nodeCount = 0;
uint16_t Capture__eventCount = 0;
uint16_t Capture__messageCount1 = 0;
uint16_t Capture__messageCount2 = 0;
uint16_t Capture__messageCount3 = 0;
uint16_t Capture__second = 0;
uint16_t Capture__requestCnt = 0;
uint16_t Capture__serialNo = 0;

bool Capture__busy = FALSE;
bool Capture__received = FALSE;
message_t Capture__pkt;



static inline void Capture__Boot__booted(void );




static inline void Capture__RadioControl__startDone(error_t err);
...
static inline void Capture__SerialControl__startDone(error_t err);
...
static inline void Capture__CC2420Config__syncDone(error_t err);
...
static inline void Capture__Timer0__fired(void );
#line 133
static inline void Capture__Timer1__fired(void );
#line 179
static inline void Capture__Timer2__fired(void );
#line 221
static inline void Capture__RadioControl__stopDone(error_t err);


static inline void Capture__SerialControl__stopDone(error_t err);


static void Capture__RadioAMSend__sendDone(message_t *msg, error_t error);
#line 354
static inline void Capture__SerialAMSend__sendDone(message_t *msg, error_t error);
#line 383
static inline message_t *Capture__RadioReceive__receive(message_t *msg, void *payload, uint8_t len);
#line 455
static inline message_t *Capture__SerialReceive__receive(message_t *msg, void *payload, uint8_t len);
# 41 "/opt/tinyos-2.1.2/tos/chips/msp430/timer/Msp430Compare.nc"
...
message_t *msg);
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
static void /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(
#line 103
message_t * msg, 
...
error_t error);
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
static error_t /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(
#line 67
message_t * msg, 
...
static void /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(
#line 99
message_t * amsg, 
...
am_addr_t addr);
#line 162
static void /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(
#line 158
message_t * amsg, 
...
static error_t /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(am_addr_t dest, 
message_t *msg, 
uint8_t len);
...
static inline void /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(message_t *m, error_t err);
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
inline static void /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__fired(uint8_t arg_0x2ba53c6f9458){
#line 39
  switch (arg_0x2ba53c6f9458) {
#line 39
    case 0:
#line 39
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerA*/Msp430TimerP__0__Event__default__fired(arg_0x2ba53c6f9458);
#line 39
      break;
#line 39
    }
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__unconfigure(uint8_t arg_0x2ba53d3349b8){
#line 65
  switch (arg_0x2ba53d3349b8) {
#line 65
...
#line 65
    default:
#line 65
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__unconfigure(arg_0x2ba53d3349b8);
#line 65
      break;
#line 65
    }
...
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__release(uint8_t arg_0x2ba53d1c2be8){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  switch (arg_0x2ba53d1c2be8) {
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__release(arg_0x2ba53d1c2be8);
#line 120
      break;
#line 120
    }
...
# 88 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCongestionBackoff(am_id_t arg_0x2ba53d8abd60, message_t * msg){
#line 88
    CC2420ActiveMessageP__RadioBackoff__default__requestCongestionBackoff(arg_0x2ba53d8abd60, msg);
#line 88
}
#line 88
...
# 128 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static bool /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__isOwner(uint8_t arg_0x2ba53d1c2be8){
#line 128
  unsigned char __nesc_result;
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__isOwner(arg_0x2ba53d1c2be8);
#line 128
      break;
#line 128
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/Msp430SpiConfigure.nc"
inline static msp430_spi_union_config_t */*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__getConfig(uint8_t arg_0x2ba53d1c1e18){
#line 39
  union __nesc_unnamed4282 *__nesc_result;
#line 39

#line 39
    __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Msp430SpiConfigure__default__getConfig(arg_0x2ba53d1c1e18);
#line 39
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__configure(uint8_t arg_0x2ba53d3349b8){
#line 59
  switch (arg_0x2ba53d3349b8) {
#line 59
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 59
    default:
#line 59
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceConfigure__default__configure(arg_0x2ba53d3349b8);
#line 59
      break;
#line 59
    }
...
# 61 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__immediateRequested(uint8_t arg_0x2ba53d3367e8){
#line 61
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__immediateRequested(arg_0x2ba53d3367e8);
#line 61
}
#line 61
...
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__immediateRequest(uint8_t arg_0x2ba53d1c2be8){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__immediateRequest(arg_0x2ba53d1c2be8);
#line 97
      break;
#line 97
    }
...
# 53 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__requested(uint8_t arg_0x2ba53d3367e8){
#line 53
    /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__ResourceRequested__default__requested(arg_0x2ba53d3367e8);
#line 53
}
#line 53
...
# 88 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__request(uint8_t arg_0x2ba53d1c2be8){
#line 88
  unsigned char __nesc_result;
#line 88
...
#line 88
    default:
#line 88
      __nesc_result = /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__UsartResource__default__request(arg_0x2ba53d1c2be8);
#line 88
      break;
#line 88
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__granted(uint8_t arg_0x2ba53db9b7e8){
#line 102
  switch (arg_0x2ba53db9b7e8) {
#line 102
...
#line 102
    default:
#line 102
      /*Msp430Uart1P.UartP*/Msp430UartP__0__Resource__default__granted(arg_0x2ba53db9b7e8);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__granted(uint8_t arg_0x2ba53d337640){
#line 102
  switch (arg_0x2ba53d337640) {
#line 102
...
#line 102
    default:
#line 102
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__Resource__default__granted(arg_0x2ba53d337640);
#line 102
      break;
#line 102
    }
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__configure(uint8_t arg_0x2ba53d3349b8){
#line 59
  switch (arg_0x2ba53d3349b8) {
#line 59
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 59
    default:
#line 59
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__configure(arg_0x2ba53d3349b8);
#line 59
      break;
#line 59
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/Msp430UartConfigure.nc"
inline static msp430_uart_union_config_t */*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__getConfig(uint8_t arg_0x2ba53db95cd0){
#line 39
  union __nesc_unnamed4286 *__nesc_result;
#line 39

#line 39
  switch (arg_0x2ba53db95cd0) {
#line 39
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 39
...
#line 39
    default:
#line 39
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__Msp430UartConfigure__default__getConfig(arg_0x2ba53db95cd0);
#line 39
      break;
#line 39
    }
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t Capture__SerialAMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__send(AM_SUCCESSMESSAGE, addr, msg, len);
#line 80
...
# 126 "/opt/tinyos-2.1.2/tos/interfaces/Packet.nc"
inline static void * Capture__RadioPacket__getPayload(message_t * msg, uint8_t len){
#line 126
  void *__nesc_result;
#line 126
...
inline static void Capture__Timer1__stop(void ){
#line 78
...
#line 354
{
  if (&Capture__pkt == msg) {
      Capture__busy = FALSE;
      if (Capture__mode == Capture__MODE_PRINT) {
          ++Capture__messageCount3;
          if (Capture__messageCount3 >= Capture__NUM_MESSAGE) {
              SuccessMessage *btrpkt;

              Capture__mode = Capture__MODE_NODE;
              Capture__Timer1__stop();

              btrpkt = (SuccessMessage *)Capture__RadioPacket__getPayload(&Capture__pkt, sizeof(SuccessMessage ));
              __nesc_hton_uint16(btrpkt->commander.nxdata, Capture__commander);
              __nesc_hton_uint16(btrpkt->nodeid1.nxdata, 0);
              __nesc_hton_uint16(btrpkt->nodeid2.nxdata, 0);
              __nesc_hton_uint16(btrpkt->stage.nxdata, Capture__MODE_NODE);
              __nesc_hton_uint16(btrpkt->countcapture1.nxdata, 0);
              __nesc_hton_uint16(btrpkt->countcapture2.nxdata, 0);
              __nesc_hton_uint16(btrpkt->serialno.nxdata, 0);
              __nesc_hton_uint16(btrpkt->capture1.nxdata, 0);
              __nesc_hton_uint16(btrpkt->capture2.nxdata, 0);
              if (Capture__SerialAMSend__send(126, &Capture__pkt, sizeof(SuccessMessage )) == SUCCESS) {
                  Capture__busy = TRUE;
                }
            }
        }
...
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__sendDone(am_id_t arg_0x2ba53d9fbe40, message_t * msg, error_t error){
#line 110
  switch (arg_0x2ba53d9fbe40) {
#line 110
    case AM_SUCCESSMESSAGE:
#line 110
      Capture__SerialAMSend__sendDone(msg, error);
#line 110
      break;
#line 110
    default:
#line 110
      /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__AMSend__default__sendDone(arg_0x2ba53d9fbe40, msg, error);
#line 110
      break;
#line 110
    }
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__sendDone(uart_id_t arg_0x2ba53daf3020, message_t * msg, error_t error){
#line 100
  switch (arg_0x2ba53daf3020) {
#line 100
...
#line 100
    default:
#line 100
      /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Send__default__sendDone(arg_0x2ba53daf3020, msg, error);
#line 100
      break;
#line 100
    }
...
# 23 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__dataLinkLength(uart_id_t arg_0x2ba53daf2308, message_t *msg, uint8_t upperLen){
#line 23
  unsigned char __nesc_result;
#line 23

#line 23
  switch (arg_0x2ba53daf2308) {
#line 23
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 23
...
#line 23
    default:
#line 23
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__dataLinkLength(arg_0x2ba53daf2308, msg, upperLen);
#line 23
      break;
#line 23
    }
...
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__offset(uart_id_t arg_0x2ba53daf2308){
#line 15
  unsigned char __nesc_result;
#line 15
...
#line 15
    default:
#line 15
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__offset(arg_0x2ba53daf2308);
#line 15
      break;
#line 15
    }
...
# 134 "/opt/tinyos-2.1.2/tos/interfaces/Leds.nc"
inline static void Capture__Leds__set(uint8_t val){
#line 134
...
# 64 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void Capture__Timer0__startPeriodic(uint32_t dt){
#line 64
...
#line 455
{
  ...
  Capture__mode = Capture__MODE_PREPROCESS;
  Capture__commander = TOS_NODE_ID;

  for (i = 0; i < Capture__NUM_MESSAGE; ++i) {
      Capture__capture1[i] = 0;
      Capture__capture2[i] = 0;
    }
  ...
  Capture__mode2 = Capture__MODE2_NODE;
  Capture__nodeCount = 0;
  Capture__eventCount = 0;
  Capture__messageCount1 = 0;
  Capture__messageCount2 = 0;
  Capture__messageCount3 = 0;
  Capture__second = 0;
  Capture__requestCnt = 0;
  Capture__serialNo = 0;

  Capture__busy = FALSE;
  Capture__received = FALSE;

  Capture__Timer0__startPeriodic(5000);
  Capture__Leds__set(1);
  return msg;
}
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__receive(am_id_t arg_0x2ba53d9f7020, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2ba53d9f7020) {
#line 78
    case AM_SUCCESSMESSAGE:
#line 78
      __nesc_result = Capture__SerialReceive__receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = /*SerialActiveMessageC.AM*/SerialActiveMessageP__0__Receive__default__receive(arg_0x2ba53d9f7020, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__receive(uart_id_t arg_0x2ba53daf43e0, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2ba53daf43e0) {
#line 78
    case TOS_SERIAL_ACTIVE_MESSAGE_ID:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__Receive__default__receive(arg_0x2ba53daf43e0, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 31 "/opt/tinyos-2.1.2/tos/lib/serial/SerialPacketInfo.nc"
inline static uint8_t /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__upperLength(uart_id_t arg_0x2ba53daf2308, message_t *msg, uint8_t dataLinkLen){
#line 31
  unsigned char __nesc_result;
#line 31
...
#line 31
    default:
#line 31
      __nesc_result = /*SerialDispatcherC.SerialDispatcherP*/SerialDispatcherP__0__PacketInfo__default__upperLength(arg_0x2ba53daf2308, msg, dataLinkLen);
#line 31
      break;
#line 31
    }
...
#line 138
  Capture__SerialControl__stopDone(error);
#line 138
}
#line 138
...
# 65 "/opt/tinyos-2.1.2/tos/interfaces/ResourceConfigure.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__unconfigure(uint8_t arg_0x2ba53d3349b8){
#line 65
  switch (arg_0x2ba53d3349b8) {
#line 65
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 65
    default:
#line 65
      /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceConfigure__default__unconfigure(arg_0x2ba53d3349b8);
#line 65
      break;
#line 65
    }
...
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__release(uint8_t arg_0x2ba53db97a20){
#line 120
  unsigned char __nesc_result;
#line 120

#line 120
  switch (arg_0x2ba53db97a20) {
#line 120
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 120
...
#line 120
    default:
#line 120
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__release(arg_0x2ba53db97a20);
#line 120
      break;
#line 120
    }
...
# 128 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static bool /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__isOwner(uint8_t arg_0x2ba53db97a20){
#line 128
  unsigned char __nesc_result;
#line 128
...
#line 128
    default:
#line 128
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__isOwner(arg_0x2ba53db97a20);
#line 128
      break;
#line 128
    }
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t Capture__RadioControl__start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
#line 113
  Capture__SerialControl__startDone(error);
#line 113
}
#line 113
...
# 61 "/opt/tinyos-2.1.2/tos/interfaces/ResourceRequested.nc"
inline static void /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__immediateRequested(uint8_t arg_0x2ba53d3367e8){
#line 61
    /*Msp430UsartShare1P.ArbiterC.Arbiter*/ArbiterP__1__ResourceRequested__default__immediateRequested(arg_0x2ba53d3367e8);
#line 61
}
#line 61
# 93 "/opt/tinyos-2.1.2/tos/system/ArbiterP.nc"
...
# 97 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static error_t /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__immediateRequest(uint8_t arg_0x2ba53db97a20){
#line 97
  unsigned char __nesc_result;
#line 97
...
#line 97
    default:
#line 97
      __nesc_result = /*Msp430Uart1P.UartP*/Msp430UartP__0__UsartResource__default__immediateRequest(arg_0x2ba53db97a20);
#line 97
      break;
#line 97
    }
...
#line 48
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(message_t * msg, error_t error){
#line 110
  Capture__RadioAMSend__sendDone(msg, error);
#line 110
}
#line 110
...
#line 65
{
  /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__sendDone(m, err);
}
...
# 100 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0x2ba53d997788, message_t * msg, error_t error){
#line 100
  switch (arg_0x2ba53d997788) {
#line 100
    case 0U:
#line 100
      /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__sendDone(msg, error);
#line 100
      break;
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0x2ba53d997788, msg, error);
#line 100
      break;
#line 100
    }
...
#line 67
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0x2ba53d996960, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = CC2420ActiveMessageP__AMSend__send(arg_0x2ba53d996960, addr, msg, len);
#line 80
...
# 59 "/opt/tinyos-2.1.2/tos/interfaces/SendNotifier.nc"
inline static void CC2420ActiveMessageP__SendNotifier__aboutToSend(am_id_t arg_0x2ba53d8ab258, am_addr_t dest, message_t * msg){
#line 59
    CC2420ActiveMessageP__SendNotifier__default__aboutToSend(arg_0x2ba53d8ab258, dest, msg);
#line 59
}
#line 59
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
...
# 95 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestCca(am_id_t arg_0x2ba53d8abd60, message_t * msg){
#line 95
    CC2420ActiveMessageP__RadioBackoff__default__requestCca(arg_0x2ba53d8abd60, msg);
#line 95
}
#line 95
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420TinyosNetworkP__Resource__granted(uint8_t arg_0x2ba53d80b280){
#line 102
  switch (arg_0x2ba53d80b280) {
#line 102
...
#line 102
    default:
#line 102
      CC2420TinyosNetworkP__Resource__default__granted(arg_0x2ba53d80b280);
#line 102
      break;
#line 102
    }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Snoop__receive(am_id_t arg_0x2ba53d8ae480, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = CC2420ActiveMessageP__Snoop__default__receive(arg_0x2ba53d8ae480, msg, payload, len);
#line 78
...
#line 383
{
  if (len == sizeof(CaptureMessage )) {
      CaptureMessage *btrpkt = (CaptureMessage *)payload;

      if (__nesc_ntoh_uint16(btrpkt->type.nxdata) == MSG_ANNOUNCE) {
          Capture__commander = __nesc_ntoh_uint16(btrpkt->id1.nxdata);
          Capture__mode2 = Capture__MODE2_PREPROCESS;
          Capture__Timer2__startPeriodic(rand() % 1000);
        }
      else {
#line 391
        if (__nesc_ntoh_uint16(btrpkt->type.nxdata) == MSG_ANNOUNCE_RETURN) {
            int exist = 0;
            int i;

#line 394
            for (i = 0; i < Capture__nodeCount; ++i) {
                if (Capture__nodes[i] == __nesc_ntoh_uint16(btrpkt->id1.nxdata)) {
                    exist = 1;
                    break;
                  }
              }
            if (exist == 0) {
                Capture__nodes[Capture__nodeCount++] = __nesc_ntoh_uint16(btrpkt->id1.nxdata);
              }
          }
        else {
#line 403
          if (__nesc_ntoh_uint16(btrpkt->type.nxdata) == MSG_SEND_REQUEST) {
              if (__nesc_ntoh_uint16(btrpkt->id1.nxdata) == TOS_NODE_ID || __nesc_ntoh_uint16(btrpkt->id2.nxdata) == TOS_NODE_ID) {
                  uint16_t i;


                  if (__nesc_ntoh_uint16(btrpkt->id1.nxdata) == TOS_NODE_ID) {
                      Capture__second = __nesc_ntoh_uint16(btrpkt->id2.nxdata);
                    }
                  else 
#line 410
                    {
                      Capture__second = __nesc_ntoh_uint16(btrpkt->id1.nxdata);
                    }

                  Capture__serialNo = __nesc_ntoh_uint16(btrpkt->serialNo.nxdata);

                  Capture__mode2 = Capture__MODE2_SENDRETURN;
                  ...
                  Capture__Timer2__startPeriodic(0);
                }
            }
          else {
#line 430
            if (__nesc_ntoh_uint16(btrpkt->type.nxdata) == MSG_SEND_RETURN) {
                uint16_t i;
                uint16_t id1 = 0;
                uint16_t id2 = 0;
...
#line 434
                for (i = 0; i < Capture__nodeCount; ++i) {
                    if (__nesc_ntoh_uint16(btrpkt->id1.nxdata) == Capture__nodes[i]) {
                        id1 = i;
                      }
                    if (__nesc_ntoh_uint16(btrpkt->id2.nxdata) == Capture__nodes[i]) {
                        id2 = i;
                      }
                  }

                if (id1 == Capture__messageCount1) {
                    Capture__capture1[__nesc_ntoh_uint16(btrpkt->serialNo.nxdata)] = 1;
                  }
                else {
#line 445
                  if (id1 == Capture__messageCount2) {
                      Capture__capture2[__nesc_ntoh_uint16(btrpkt->serialNo.nxdata)] = 1;
                    }
                  }
#line 448
                Capture__received = TRUE;
              }
            }
          }
        }
...
# 78 "/opt/tinyos-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * CC2420ActiveMessageP__Receive__receive(am_id_t arg_0x2ba53d8b0908, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0x2ba53d8b0908) {
#line 78
    case 6:
#line 78
      __nesc_result = Capture__RadioReceive__receive(msg, payload, len);
#line 78
      break;
#line 78
    default:
#line 78
      __nesc_result = CC2420ActiveMessageP__Receive__default__receive(arg_0x2ba53d8b0908, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__granted(uint8_t arg_0x2ba53d1cacc0){
#line 102
  switch (arg_0x2ba53d1cacc0) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 102
...
#line 102
    default:
#line 102
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__Resource__default__granted(arg_0x2ba53d1cacc0);
#line 102
      break;
#line 102
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__granted(uint8_t arg_0x2ba53d337640){
#line 102
  switch (arg_0x2ba53d337640) {
#line 102
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 102
    default:
#line 102
      /*Msp430UsartShare0P.ArbiterC.Arbiter*/ArbiterP__0__Resource__default__granted(arg_0x2ba53d337640);
#line 102
      break;
#line 102
    }
...
# 82 "/opt/tinyos-2.1.2/tos/interfaces/SpiPacket.nc"
inline static void /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__sendDone(uint8_t arg_0x2ba53d1c3e38, uint8_t * txBuf, uint8_t * rxBuf, uint16_t len, error_t error){
#line 82
  switch (arg_0x2ba53d1c3e38) {
#line 82
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC*/Msp430Spi0C__0__CLIENT_ID:
#line 82
...
#line 82
    default:
#line 82
      /*Msp430SpiNoDma0P.SpiP*/Msp430SpiNoDmaP__0__SpiPacket__default__sendDone(arg_0x2ba53d1c3e38, txBuf, rxBuf, len, error);
#line 82
      break;
#line 82
    }
...
# 71 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__readDone(uint8_t arg_0x2ba53d0c3328, uint8_t * data, uint8_t length, error_t error){
#line 71
  switch (arg_0x2ba53d0c3328) {
#line 71
    case CC2420_TXFIFO:
#line 71
...
#line 71
    default:
#line 71
      CC2420SpiP__Fifo__default__readDone(arg_0x2ba53d0c3328, data, length, error);
#line 71
      break;
#line 71
    }
...
# 81 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/RadioBackoff.nc"
inline static void CC2420ActiveMessageP__RadioBackoff__requestInitialBackoff(am_id_t arg_0x2ba53d8abd60, message_t * msg){
#line 81
    CC2420ActiveMessageP__RadioBackoff__default__requestInitialBackoff(arg_0x2ba53d8abd60, msg);
#line 81
}
#line 81
...
# 91 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Fifo.nc"
inline static void CC2420SpiP__Fifo__writeDone(uint8_t arg_0x2ba53d0c3328, uint8_t * data, uint8_t length, error_t error){
#line 91
  switch (arg_0x2ba53d0c3328) {
#line 91
    case CC2420_TXFIFO:
...
#line 91
    default:
#line 91
      CC2420SpiP__Fifo__default__writeDone(arg_0x2ba53d0c3328, data, length, error);
#line 91
      break;
#line 91
    }
...
# 102 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
inline static void CC2420SpiP__Resource__granted(uint8_t arg_0x2ba53d0c4158){
#line 102
  switch (arg_0x2ba53d0c4158) {
#line 102
...
#line 102
    default:
#line 102
      CC2420SpiP__Resource__default__granted(arg_0x2ba53d0c4158);
#line 102
      break;
#line 102
    }
...
#line 63
# 54 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Config.nc"
inline static error_t Capture__CC2420Config__sync(void ){
#line 54
  unsigned char __nesc_result;
#line 54
...
#line 55
  Capture__CC2420Config__syncDone(error);
#line 55
}
#line 55
...
#line 88
# 465 "/opt/tinyos-2.1.2/tos/chips/cc2420/control/CC2420ControlP.nc"
static inline void CC2420ControlP__sync__runTask(void )
#line 465
{
...
#line 100
# 110 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static void CC2420ActiveMessageP__AMSend__sendDone(am_id_t arg_0x2ba53d8b17d8, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0x2ba53d8b17d8, msg, error);
#line 110
}
#line 110
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
...
#line 138
  Capture__RadioControl__stopDone(error);
#line 138
}
#line 138
...
# 294 "/opt/tinyos-2.1.2/tos/chips/cc2420/control/CC2420ControlP.nc"
static inline void CC2420ControlP__CC2420Config__setChannel(uint8_t channel)
#line 294
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
...
# 61 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Config.nc"
inline static void Capture__CC2420Config__setChannel(uint8_t channel){
#line 61
...
{
  if (err == SUCCESS) {
      Capture__CC2420Config__setChannel(19);
      Capture__CC2420Config__sync();
    }
  else 
#line 83
...
#line 113
  Capture__RadioControl__startDone(error);
#line 113
}
#line 113
# 120 "/opt/tinyos-2.1.2/tos/interfaces/Resource.nc"
...
# 78 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void Capture__Timer0__stop(void ){
#line 78
...
#line 103
{
  if (Capture__mode == Capture__MODE_PREPROCESS) {
      Capture__messageCount1 = 0;
      Capture__messageCount2 = 0;
      Capture__Timer0__stop();
      Capture__Timer1__startPeriodic(TIMER_PERIOD_MILLI);
    }
  else {
#line 109
    if (Capture__mode == Capture__MODE_WATING1) {
        Capture__mode = Capture__MODE_SENDREQUEST;
        Capture__messageCount1 = 2;
        Capture__messageCount2 = 1;
        Capture__messageCount3 = 0;
        Capture__Timer0__stop();
        Capture__Timer1__startPeriodic(TIMER_PERIOD_MILLI);
      }
...
#line 116
      if (Capture__mode == Capture__MODE_WATING2) {
          Capture__mode = Capture__MODE_PRINT;
          Capture__messageCount1 = 2;
          Capture__messageCount2 = 1;
          Capture__messageCount3 = 0;
          Capture__Timer0__stop();
...
# 80 "/opt/tinyos-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t Capture__RadioAMSend__send(am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMSend__send(addr, msg, len);
#line 80
...
#line 80
# 56 "/opt/tinyos-2.1.2/tos/chips/cc2420/interfaces/CC2420Packet.nc"
inline static void Capture__CC2420Packet__setPower(message_t *p_msg, uint8_t power){
#line 56
...
#line 133
{
  if (!Capture__busy) {
      if (Capture__mode == Capture__MODE_PREPROCESS) {
          CaptureMessage *m = (CaptureMessage *)Capture__RadioPacket__getPayload(&Capture__pkt, sizeof(CaptureMessage ));

#line 137
          __nesc_hton_uint16(m->type.nxdata, MSG_ANNOUNCE);
          __nesc_hton_uint16(m->id1.nxdata, TOS_NODE_ID);
          Capture__CC2420Packet__setPower(&Capture__pkt, Capture__POWER);
          Capture__RadioAMSend__send(AM_BROADCAST_ADDR, &Capture__pkt, sizeof(CaptureMessage ));
        }
      else {
#line 141
        if (Capture__mode == Capture__MODE_SENDREQUEST) {
            ...
            CaptureMessage *btrpkt = (CaptureMessage *)Capture__RadioPacket__getPayload(&Capture__pkt, sizeof(CaptureMessage ));

#line 151
            __nesc_hton_uint16(btrpkt->type.nxdata, MSG_SEND_REQUEST);
            __nesc_hton_uint16(btrpkt->id1.nxdata, Capture__nodes[Capture__messageCount1]);
            __nesc_hton_uint16(btrpkt->id2.nxdata, Capture__nodes[Capture__messageCount2]);
            __nesc_hton_uint16(btrpkt->serialNo.nxdata, Capture__serialNo);
            Capture__CC2420Packet__setPower(&Capture__pkt, Capture__POWER);
            if (Capture__RadioAMSend__send(AM_BROADCAST_ADDR, &Capture__pkt, sizeof(CaptureMessage )) == SUCCESS) {
                Capture__busy = TRUE;
              }
          }
        else {
#line 159
          if (Capture__mode == Capture__MODE_PRINT) {
              ...
              btrpkt = (SuccessMessage *)Capture__RadioPacket__getPayload(&Capture__pkt, sizeof(SuccessMessage ));
              __nesc_hton_uint16(btrpkt->commander.nxdata, Capture__commander);
              __nesc_hton_uint16(btrpkt->nodeid1.nxdata, Capture__nodes[Capture__messageCount1]);
              __nesc_hton_uint16(btrpkt->nodeid2.nxdata, Capture__nodes[Capture__messageCount2]);
              __nesc_hton_uint16(btrpkt->stage.nxdata, Capture__MODE_PRINT);
              __nesc_hton_uint16(btrpkt->countcapture1.nxdata, 0);
              __nesc_hton_uint16(btrpkt->countcapture2.nxdata, 0);
              __nesc_hton_uint16(btrpkt->serialno.nxdata, Capture__messageCount3);
              __nesc_hton_uint16(btrpkt->capture1.nxdata, Capture__capture1[Capture__messageCount3]);
              __nesc_hton_uint16(btrpkt->capture2.nxdata, Capture__capture2[Capture__messageCount3]);
              if (Capture__SerialAMSend__send(126, &Capture__pkt, sizeof(SuccessMessage )) == SUCCESS) {
                  Capture__busy = TRUE;
                }
            }
...
# 78 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void Capture__Timer2__stop(void ){
#line 78
...
#line 179
{
  if (Capture__busy == FALSE) {
      if (Capture__mode2 == Capture__MODE2_PREPROCESS) {
          CaptureMessage *m = (CaptureMessage *)Capture__RadioPacket__getPayload(&Capture__pkt, sizeof(CaptureMessage ));

#line 183
          __nesc_hton_uint16(m->type.nxdata, MSG_ANNOUNCE_RETURN);
          __nesc_hton_uint16(m->id1.nxdata, TOS_NODE_ID);
          Capture__CC2420Packet__setPower(&Capture__pkt, Capture__POWER);
          Capture__RadioAMSend__send(Capture__commander, &Capture__pkt, sizeof(CaptureMessage ));
          Capture__Leds__set(1);
          Capture__Timer2__stop();
        }
      else {
#line 189
        if (Capture__mode2 == Capture__MODE2_SENDRETURN) {
            CaptureMessage *m = (CaptureMessage *)Capture__RadioPacket__getPayload(&Capture__pkt, sizeof(CaptureMessage ));

#line 191
            __nesc_hton_uint16(m->type.nxdata, MSG_SEND_RETURN);
            __nesc_hton_uint16(m->id1.nxdata, TOS_NODE_ID);
            __nesc_hton_uint16(m->id2.nxdata, Capture__second);
            __nesc_hton_uint16(m->serialNo.nxdata, Capture__serialNo);

            Capture__CC2420Packet__setPower(&Capture__pkt, Capture__POWER);
            if (Capture__RadioAMSend__send(Capture__commander, &Capture__pkt, sizeof(CaptureMessage )) == SUCCESS) {
                Capture__busy = TRUE;
              }
...
# 83 "/opt/tinyos-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0x2ba53ccf45d8){
#line 83
  switch (arg_0x2ba53ccf45d8) {
#line 83
    case 0U:
#line 83
      Capture__Timer0__fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      Capture__Timer1__fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      Capture__Timer2__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0x2ba53ccf45d8);
#line 83
      break;
#line 83
    }
...
# 103 "/opt/tinyos-2.1.2/tos/interfaces/AMPacket.nc"
inline static void /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(message_t * amsg, am_addr_t addr){
#line 103
...
inline static void /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(message_t * amsg, am_id_t t){
#line 162
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/Send.nc"
inline static error_t /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(message_t * msg, uint8_t len){
#line 75
  unsigned char __nesc_result;
#line 75
...
# 104 "/opt/tinyos-2.1.2/tos/interfaces/SplitControl.nc"
inline static error_t Capture__SerialControl__start(void ){
#line 104
  unsigned char __nesc_result;
#line 104
...
# 54 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__rxDone(uint8_t arg_0x2ba53d323800, uint8_t data){
#line 54
  switch (arg_0x2ba53d323800) {
#line 54
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
#line 54
...
#line 54
    default:
#line 54
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__rxDone(arg_0x2ba53d323800, data);
#line 54
      break;
#line 54
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430I2CInterrupts.nc"
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__fired(uint8_t arg_0x2ba53d322620){
#line 39
    /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__I2CInterrupts__default__fired(arg_0x2ba53d322620);
#line 39
}
#line 39
...
inline static void /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__txDone(uint8_t arg_0x2ba53d323800){
#line 49
  switch (arg_0x2ba53d323800) {
#line 49
    case /*CC2420SpiWireC.HplCC2420SpiC.SpiC.UsartC*/Msp430Usart0C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare0P.UsartShareP*/Msp430UsartShareP__0__Interrupts__default__txDone(arg_0x2ba53d323800);
#line 49
      break;
#line 49
    }
...
# 79 "/opt/tinyos-2.1.2/tos/interfaces/UartStream.nc"
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receivedByte(uint8_t arg_0x2ba53db997e0, uint8_t byte){
#line 79
  switch (arg_0x2ba53db997e0) {
#line 79
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
#line 79
...
#line 79
    default:
#line 79
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receivedByte(arg_0x2ba53db997e0, byte);
#line 79
      break;
#line 79
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__receiveDone(uint8_t arg_0x2ba53db997e0, uint8_t * buf, uint16_t len, error_t error){
#line 99
  switch (arg_0x2ba53db997e0) {
#line 99
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 99
    default:
#line 99
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__receiveDone(arg_0x2ba53db997e0, buf, len, error);
#line 99
      break;
#line 99
    }
...
# 54 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__rxDone(uint8_t arg_0x2ba53d323800, uint8_t data){
#line 54
  switch (arg_0x2ba53d323800) {
#line 54
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 54
    default:
#line 54
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__rxDone(arg_0x2ba53d323800, data);
#line 54
      break;
#line 54
    }
...
inline static void /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__sendDone(uint8_t arg_0x2ba53db997e0, uint8_t * buf, uint16_t len, error_t error){
#line 57
  switch (arg_0x2ba53db997e0) {
#line 57
    case /*PlatformSerialC.UartC*/Msp430Uart1C__0__CLIENT_ID:
...
#line 57
    default:
#line 57
      /*Msp430Uart1P.UartP*/Msp430UartP__0__UartStream__default__sendDone(arg_0x2ba53db997e0, buf, len, error);
#line 57
      break;
#line 57
    }
...
# 49 "/opt/tinyos-2.1.2/tos/chips/msp430/usart/HplMsp430UsartInterrupts.nc"
inline static void /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__txDone(uint8_t arg_0x2ba53d323800){
#line 49
  switch (arg_0x2ba53d323800) {
#line 49
    case /*PlatformSerialC.UartC.UsartC*/Msp430Usart1C__0__CLIENT_ID:
...
#line 49
    default:
#line 49
      /*Msp430UsartShare1P.UsartShareP*/Msp430UsartShareP__1__Interrupts__default__txDone(arg_0x2ba53d323800);
#line 49
      break;
#line 49
    }
...
# 39 "/opt/tinyos-2.1.2/tos/chips/msp430/timer/Msp430TimerEvent.nc"
static void /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__fired(uint8_t arg_0x2ba53c6f9458){
#line 39
  switch (arg_0x2ba53c6f9458) {
#line 39
    case 0:
...
#line 39
    default:
#line 39
      /*Msp430TimerC.Msp430TimerB*/Msp430TimerP__1__Event__default__fired(arg_0x2ba53c6f9458);
#line 39
      break;
#line 39
    }
...
# 75 "/opt/tinyos-2.1.2/tos/interfaces/TaskBasic.nc"
static void SchedulerBasicP__TaskBasic__runTask(uint8_t arg_0x2ba53c605650){
#line 75
  switch (arg_0x2ba53c605650) {
#line 75
...
#line 75
    default:
#line 75
      SchedulerBasicP__TaskBasic__default__runTask(arg_0x2ba53c605650);
#line 75
      break;
#line 75
    }
...
#line 227
{
  if (&Capture__pkt == msg) {
      ...
      if (Capture__mode == Capture__MODE_PREPROCESS) {
          ++Capture__messageCount1;
          if (Capture__messageCount1 >= 1000) {
              if (Capture__nodeCount == 0) {
                  SuccessMessage *btrpkt;
                  ...
                  __nesc_hton_uint16(btrpkt->capture1.nxdata, 0);
                  __nesc_hton_uint16(btrpkt->capture2.nxdata, 0);
                  __nesc_hton_uint16(btrpkt->nbr1capture[0].nxdata, 37);
                  __nesc_hton_uint16(btrpkt->nbr1capture[1].nxdata, 85);
                  if (Capture__SerialAMSend__send(126, &Capture__pkt, sizeof(SuccessMessage )) == SUCCESS) {
                      Capture__busy = TRUE;
                    }
                }
...
#line 255
                {
                  ...
                  Capture__mode = Capture__MODE_WATING1;
                  Capture__Timer1__stop();
                  Capture__Timer0__startPeriodic(5000);
                  ...
                  __nesc_hton_uint16(btrpkt->nodeid1.nxdata, 0);
                  __nesc_hton_uint16(btrpkt->nodeid2.nxdata, 0);
                  __nesc_hton_uint16(btrpkt->stage.nxdata, Capture__MODE_PREPROCESS);
                  __nesc_hton_uint16(btrpkt->countcapture1.nxdata, 0);
                  __nesc_hton_uint16(btrpkt->countcapture2.nxdata, 0);
                  __nesc_hton_uint16(btrpkt->serialno.nxdata, 0);
                  __nesc_hton_uint16(btrpkt->capture1.nxdata, 0);
...
#line 304
            Capture__serialNo++;
            ++Capture__messageCount3;
            if (Capture__messageCount3 >= Capture__NUM_REPEAT) {
                ...
                Capture__mode = Capture__MODE_WATING2;
                Capture__messageCount3 = 0;
                Capture__Timer1__stop();
                Capture__Timer0__startPeriodic(5000);

                for (i = 0; i < Capture__NUM_MESSAGE; ++i) {
                    cnt1 = cnt1 + Capture__capture1[i];
                    cnt2 = cnt2 + Capture__capture2[i];
                  }
                ...
                __nesc_hton_uint16(btrpkt->nodeid1.nxdata, Capture__nodes[Capture__messageCount1]);
                __nesc_hton_uint16(btrpkt->nodeid2.nxdata, Capture__nodes[Capture__messageCount2]);
                __nesc_hton_uint16(btrpkt->stage.nxdata, Capture__MODE_SENDREQUEST);
                __nesc_hton_uint16(btrpkt->countcapture1.nxdata, cnt1);
                __nesc_hton_uint16(btrpkt->countcapture2.nxdata, cnt2);
                __nesc_hton_uint16(btrpkt->serialno.nxdata, 0);
                __nesc_hton_uint16(btrpkt->capture1.nxdata, 0);
                __nesc_hton_uint16(btrpkt->capture2.nxdata, 0);
                if (Capture__SerialAMSend__send(126, &Capture__pkt, sizeof(SuccessMessage )) == SUCCESS) {
...
#line 55
{
  /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setDestination(msg, dest);
  /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__AMPacket__setType(msg, 6);
  return /*CaptureApp.AMSenderC.SenderC.AMQueueEntryP*/AMQueueEntryP__0__Send__send(msg, len);
}
